...
1. **Reporte Privadamente**
   - Use o recurso de [Security Advisories](https://github.com/rafaelakio/webscrap/security/advisories/new) do GitHub
...
- **GitHub Security**: [Security Advisories](https://github.com/rafaelakio/webscrap/security/advisories)

Para outras questões:
- **Issues**: [GitHub Issues](https://github.com/rafaelakio/webscrap/issues)
